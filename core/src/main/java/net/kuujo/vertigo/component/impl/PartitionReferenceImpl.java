...
/**
 * Partition reference implementation.
 *
 * @author <a href="http://github.com/kuujo">Jordan Halterman</a>
 */
public class PartitionReferenceImpl implements PartitionReference {
  private final Vertx vertx;
  private final PartitionContext context;

  public PartitionReferenceImpl(Vertx vertx, PartitionContext context) {
    this.vertx = vertx;
