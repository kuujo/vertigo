...
public class ConnectionDefinitionImpl implements ConnectionDefinition {
   ...
   * {@link net.kuujo.vertigo.connection.SourceDefinition} documentation for details on the source structure.
   */
  public static final String CONNECTION_SOURCE = "source";

  /**
   * <code>target</code> is an object defining the connection target. See the
   * {@link net.kuujo.vertigo.connection.TargetDefinition} documentation for details on the target structure.
   */
