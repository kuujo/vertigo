 ...
 * access to a {@link Vertigo} instance for creating feeders, workers, and executors.
 * When implemented inside a component verticle, the verticle's configuration
 * will be automatically populated with the component configuration as well (as
 * was indicated when defining the network).
 *
