...
/**
 * Exactly once input connection implementation.
 *
 * @author Jordan Halterman
 */
public class ExactlyOnceInputConnection extends BaseInputConnection {

  public ExactlyOnceInputConnection(Vertx vertx, InputConnectionContext context, VertigoCluster cluster, MessageAcker acker) {
