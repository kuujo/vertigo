 ...
 */
public class BasicOutputConnection implements OutputConnection, Observer<OutputConnectionContext> {
  ...
  protected BasicOutputConnection(Vertx vertx, OutputConnectionContext context, VertigoCluster cluster) {
    this.vertx = vertx;
