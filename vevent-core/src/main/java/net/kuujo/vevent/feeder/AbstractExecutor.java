...
public abstract class AbstractExecutor extends AbstractFeeder {
  ...
  public AbstractExecutor(NetworkContext context, Vertx vertx) {
    super(context, vertx);
  }

  public AbstractExecutor(NetworkContext context, EventBus eventBus) {
    super(context, eventBus);
  }

  public AbstractExecutor(NetworkContext context, Vertx vertx, EventBus eventBus) {
