...
public class RecurringEmbeddedFeeder implements EmbeddedFeeder<EmbeddedFeeder> {
  ...
  @Override
  public EmbeddedFeeder ackHandler(Handler<JsonObject> ackHandler) {
    return this;
  }

  @Override
  public EmbeddedFeeder failHandler(Handler<JsonObject> failHandler) {
    return this;
  }
