 ...
 */
public class RemoteVitis implements Vitis {
  ...
  public RemoteVitis(String address) {
    this.address = address;
  }

  public RemoteVitis(String address, Vertx vertx) {
    this.address = address;
    this.vertx = vertx;
    setEventBus(vertx.eventBus());
  }

  public RemoteVitis(String address, Vertx vertx, Container container) {
    this.address = address;
    this.vertx = vertx;
  ...
  public RemoteVitis(String address, Vertx vertx, Container container, EventBus eventBus) {
    this.address = address;
    this.vertx = vertx;
    this.container = container;
  ...
  public RemoteVitis setAddress(String address) {
    this.address = address;
    return this;
  }
   ...
   */
  public RemoteVitis setEventBus(EventBus eventBus) {
