...
/**
 * A reliable stream feeder verticle.
 *
 * @author Jordan Halterman
 */
public abstract class ReliableStreamFeederVerticle extends Verticle {

  private ReliableStreamFeeder feeder;
  ...
  @Override
  public void start() {
    feeder = new ReliableStreamFeeder(vertx, container, new WorkerContext(container.config()));
   ...
   */
  protected abstract void feed(ReliableStreamFeeder feeder);
