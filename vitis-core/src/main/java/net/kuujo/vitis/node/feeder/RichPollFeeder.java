...
/**
 * A rich poll feeder implementation.
 *
 * @author Jordan Halterman
 */
public class RichPollFeeder extends AbstractFeeder implements PollFeeder<RichPollFeeder>, RichFeeder<RichPollFeeder> {

  protected Handler<RichPollFeeder> feedHandler;

  private boolean fed;

  private long feedDelay = 100;

  public RichPollFeeder(Vertx vertx, Container container, WorkerContext context) {
  ...
  @Override
  public RichPollFeeder setDefaultTimeout(long timeout) {
    queue.setDefaultTimeout(timeout);
    return this;
  }

  @Override
  public RichPollFeeder setFeedDelay(long delay) {
    feedDelay = delay;
    return this;
  }
  ...
  @Override
  public RichPollFeeder setFeedQueueMaxSize(long maxSize) {
  ...
  @Override
  public RichPollFeeder feed(JsonObject data) {
  ...
  @Override
  public RichPollFeeder feed(JsonObject data, String tag) {
  ...
  @Override
  public RichPollFeeder feed(JsonObject data, Handler<AsyncResult<Void>> ackHandler) {
  ...
  @Override
  public RichPollFeeder feed(JsonObject data, long timeout, Handler<AsyncResult<Void>> ackHandler) {
    JsonMessage message = DefaultJsonMessage.create(data);
  ...
  @Override
  public RichPollFeeder feed(JsonObject data, String tag, Handler<AsyncResult<Void>> ackHandler) {
  ...
  @Override
  public RichPollFeeder feed(JsonObject data, String tag, long timeout, Handler<AsyncResult<Void>> ackHandler) {
    JsonMessage message = DefaultJsonMessage.create(data, tag);
    queue.enqueue(message.id(), timeout, ackHandler);
    output.emit(message);
    return this;
  ...
  @Override
  public RichPollFeeder feedHandler(Handler<RichPollFeeder> handler) {
